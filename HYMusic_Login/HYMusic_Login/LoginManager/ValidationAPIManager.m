...
@interface ValidationAPIManager() <ZYAPIManagerValidator,ZYAPIManagerParamSource,ZYAPIManagerInterceptor>
@end
@implementation ValidationAPIManager
- (instancetype)init{
    self = [super init];
    if (self) {
...
- (ZYAPIManagerRequestType)requestType{
    return ZYAPIManagerRequestTypeGet;
}
