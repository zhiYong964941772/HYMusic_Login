...
@interface CHangePasswordAPIManager() <ZYAPIManagerValidator,ZYAPIManagerParamSource,ZYAPIManagerInterceptor>
@end
@implementation CHangePasswordAPIManager
- (instancetype)init{
    self = [super init];
    if (self) {
